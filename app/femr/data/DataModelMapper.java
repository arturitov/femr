...
public class DataModelMapper implements IDataModelMapper{
     ...
     */
    @Override
    public IPatient createPatient(int userID, String firstName, String lastName, Date birthday, String sex, String address, String city, Integer photoID, String ageClassification) {
        ...
        if (ageClassification != null)
            patient.setAgeClassification(ageClassification);
