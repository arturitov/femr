...
public class EditViewModel {
    ...
    public List<ValidationError> validate(){
        ...
        if (!newPassword.equals(newPasswordVerify))
            ...
            errors.add(new ValidationError("newPasswordVerify", "verify password field is empty"));
        else {
            if(newPassword.length() > 0 && (newPassword.length() < 6 || !hasUppercase.matcher(newPassword).find()
